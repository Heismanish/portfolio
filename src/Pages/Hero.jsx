...
// 			className="h-auto lg:h-screen my-16 gap-18 md:gap-16 flex items-center justify-center w-full "
// 		>
...
// 								I&apos;m a MERN stack web developer with a passion for open
// 								source. Let&apos;s create something extraordinary together!
// 							</p>
// 						</div>
...
export default function Hero() {
	return (
		<div className="h-auto lg:h-screen my-16 gap-18 md:gap-16 flex items-center justify-center w-full">
			<div className="w-90vw mx-auto max-w-screen-lg">
				<div className="grid lg:grid-cols-hero-layout gap-4 lg:gap-12 grid-cols-1">
					<div className="hidden lg:flex order-last lg:order-first lg:flex-col lg:gap-6 self-center justify-evenly">
						<a
